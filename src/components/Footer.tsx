    ...
    <div className="py-24 px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-64 bg-gray-100 text-sm mt-24">
      ...
      <div className="flex flex-col md:flex-row justify-between gap-24">
        ...
        <div className="w-full md:w-1/2 lg:w-1/4 flex flex-col gap-8">
          ...
          <p className="">Nasir City, Cairo, Egypt</p>
          <span className="font-semibold">abc@shory.com</span>
          <span className="font-semibold">+2 383-2870-453</span>
          <div className="flex gap-6">
            ...
            <Image
              ...
              height={16}
            />
            <Image src="/x.png" alt="twitter logo" width={16} height={16} />
          </div>
        </div>
        {/* CENTER */}
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-8 mt-16">
        <div className="">&#169;2024 ABC Shop</div>
